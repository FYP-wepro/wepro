      ...
      <div class="wizard-form">
        <div class="wizard-header">
          ...
          <p>Fill all form field to go next step</p>
            ...
            <form class="form-register" action="#" method="GET">
              <div id="form-total">
                ...
                <div class="form-row">
                     ...
                     <div class="form-group col-md-4" style="max-width: 100%;height: 30px;">
                       <label for="inputState">Select Main catagory</label>
                         ...
                         echo '<select id="catagory" name="catagory" class="form-control" style="float:right;">';
...
<input type="checkbox" class="main" name="main[]" value="<?php echo $catagory->name?>"><?php echo $catagory->name;?>
</div>
@endforeach
-->
...
$("#btn5").click(function(e){
  ...
  $.get('/wepro/public/ajax', function(data){
